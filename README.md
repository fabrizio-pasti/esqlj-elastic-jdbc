...
esqlj not use at all Sql Elastic implementation, Elastic integration is built on top of Elastic Rest High Level API. See Elastic licenses in folder `licenses/Elasticsearch`
