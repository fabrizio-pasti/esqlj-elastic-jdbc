...
public class ResultSetMetaDataElasticImpl extends AbstractResultSetMetaData {

	private List<ElasticFieldType> columnTypes;
	
	public ResultSetMetaDataElasticImpl(String source, List<String> columnsName, List<DataRow> dataRows) {
