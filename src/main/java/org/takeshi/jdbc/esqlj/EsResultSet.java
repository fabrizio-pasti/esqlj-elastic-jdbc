...
public class EsResultSet implements ResultSet {
	...
	public ResultSetMetaData getMetaData() throws SQLException {
		return query.getResultSetMetaData();
	}
	...
	public boolean last() throws SQLException {
		return query.moveToLast();
	}

	@Override
	public int getRow() throws SQLException {
		return query.getCurrentRowIndex();
	}

	@Override
	public boolean absolute(int row) throws SQLException {
		return query.moveToRow(row);
	}

	@Override
	public boolean relative(int rows) throws SQLException {
		return query.moveByDelta(rows);
	}

	@Override
	public boolean previous() throws SQLException {
		return query.moveByDelta(-1);
	}
	...
	public int getType() throws SQLException {
		return query.isForwardOnly() ? ResultSet.TYPE_FORWARD_ONLY : ResultSet.TYPE_SCROLL_SENSITIVE;
	}
